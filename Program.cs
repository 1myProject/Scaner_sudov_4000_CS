...
namespace scaner_sudov {
    class Program {
        static String date_my = DateTime.UtcNow.ToString("dd.MM.yyyyy");
        ...
        static void Main(string[] args) {
            ...
            StreamWriter SUD_F = new StreamWriter(path + "\\1_SUD-"+date_my+".txt", false, Encoding.GetEncoding(1251));
            StreamWriter ADM_F = new StreamWriter(path + "\\1_ADM-"+date_my+".txt", false, Encoding.GetEncoding(1251));
            ...
            //File.WriteAllText(path + "\\1_SUD.txt", File.ReadAllText(path + "\\1_SUD.txt", Encoding.Default), Encoding.GetEncoding(1251));
            //File.WriteAllText(path + "\\1_ADM.txt", File.ReadAllText(path + "\\1_ADM.txt", Encoding.Default), Encoding.GetEncoding(1251));
        }
    }
}
